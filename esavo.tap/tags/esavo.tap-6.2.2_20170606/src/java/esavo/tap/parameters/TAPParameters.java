...
public class TAPParameters extends UwsJobParameters {
	...
	public static final String COMMON_OUTPUT_FORMAT = "votable";
	...
	public static final String PARAM_WRITTEN_SIZE = "written_size";
	public static final String PARAM_WRITTEN_ROWS = "written_rows";
	...
	public static final String PARAM_TAP_LIB_VERSION = "lib_tap_version";
	...
	public final String getCaption(){
		return getStringParam(PARAM_CAPTION);
	}
	...
	public final String getPage(){
		return getStringParam(PARAM_PAGE);
	}
	
	public final String getPageSize(){
		return getStringParam(PARAM_PAGE_SIZE);
	}
