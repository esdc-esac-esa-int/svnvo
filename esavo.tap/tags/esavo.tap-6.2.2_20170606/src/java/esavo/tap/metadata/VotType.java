...
public final class VotType {
	...
	public VotType(final String datatype, final int arraysize, final String xtype){
		...
		this.xtype = (xtype!=null && xtype.trim().length()>0)?xtype:null;
	}
	...
	public boolean equals(Object obj) {
		...
		try{
			...
			if (datatype.equalsIgnoreCase(vot.datatype) && isArray(arraysize)==isArray(vot.arraysize)){
				if (xtype == null)
	...
	private boolean isArray(int arraySize){
		return arraySize!=1;
	}
