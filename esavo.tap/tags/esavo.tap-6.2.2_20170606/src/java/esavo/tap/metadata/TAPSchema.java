...
public class TAPSchema {
	...
	protected Map<String, TAPTable> tables;
	protected Map<String, TAPFunction> functions;
...
//		this(schemaName, description, null, null, null);
//	}

	public TAPSchema(String schemaName, String description, String utype, String title, boolean isPublic){
		init(schemaName);
	...
	public TAPTable addTable(String tableName, boolean isPublic){
		if (tableName == null)
			return null;

		TAPTable t = new TAPTable(tableName, isPublic);
		addTable(t);
		return t;
	}

	public TAPTable addTable(String tableName, String tableType, String description, String utype, boolean isPublic){
		if (tableName == null)
			return null;

		TAPTable t = new TAPTable(tableName, tableType, description, utype, isPublic);
		addTable(t);
		return t;
	}
