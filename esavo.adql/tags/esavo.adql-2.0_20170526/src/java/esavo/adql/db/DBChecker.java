...
import esavo.adql.db.exception.UnresolvedColumnException;
import esavo.adql.db.exception.UnresolvedIdentifiersException;
...
import esavo.adql.search.SearchColumnHandler;
import esavo.adql.search.SimpleSearchHandler;
 ...
 * 	can be replaced in SQL by their DB name, if different. This mapping is done automatically by {@link esavo.adql.translator.PostgreSQLTranslator}.
 * </i></p>
 * 
