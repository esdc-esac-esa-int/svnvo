...
public interface DBColumn {
	 ...
	 * @param adqlName	Its new ADQL name.
	 * @param dbTable	Its new table.
	 * @param findTableName flag to parse/not parse adqlName. (adqlName can contains '.'. Usually, it is schema.name syntax. But when
	 * adqlName is an alias, no parsing is required.
	 * 
	 * @return			A modified copy of this {@link DBColumn}.
	 */
	public DBColumn copy(final String dbName, final String adqlName, final DBTable dbTable, boolean findTableName);
