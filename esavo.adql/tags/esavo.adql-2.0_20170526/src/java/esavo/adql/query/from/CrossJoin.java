...
public class CrossJoin extends ADQLJoin {
	 ...
	 * 
	 * @see esavo.adql.query.from.ADQLJoin#setNatural(boolean)
	 */
	@Override
	 ...
	 * 
	 * @see esavo.adql.query.from.ADQLJoin#setJoinCondition(esavo.adql.query.ClauseConstraints)
	 */
	@Override
	 ...
	 * 
	 * @see esavo.adql.query.from.ADQLJoin#setJoinedColumns(java.util.Collection)
	 */
	@Override
