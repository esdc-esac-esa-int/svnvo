 ...
 * 
 * <p><i><u>Example:</u>
 * <p>CENTROID(CIRCLE('ICRS GEOCENTER', 25.4, -20.0, 1))
 * <p>In this example the function computes the centroid of a circle of one degree radius centered
...
public class CentroidFunction extends GeometryFunction {
	...
	public GeometryValue<GeometryFunction> getParameter() {
		return parameter;
	}

	public void setParameter(GeometryValue<GeometryFunction> parameter) {
