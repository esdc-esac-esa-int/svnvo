 ...
 * @version 01/2012
 * 
 * @see esavo.adql.query.constraint.ConstraintsGroup
 */
public class ClauseConstraints extends ClauseADQL<ADQLConstraint> {
	...
	/**
	 * @see esavo.adql.query.ADQLList#add(esavo.adql.query.ADQLObject)
	...
	/**
	 * @see esavo.adql.query.ADQLList#add(int, esavo.adql.query.ADQLObject)
	...
	/**
	 * @see esavo.adql.query.ADQLList#set(int, esavo.adql.query.ADQLObject)
	 ...
	 * @throws NullPointerException				If the given constraint is <i>null</i>.
	 * @throws ArrayIndexOutOfBoundsException	If the given index is incorrect (index &lt; 0 || index gt;= size()).
	 * 
	 ...
	 * 
	 * @see esavo.adql.query.ADQLList#getPossibleSeparators()
	 */
	@Override
