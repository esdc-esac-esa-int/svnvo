 ...
 * 
 * <p><i><u>Example:</u>
 * <p>POLYGON('ICRS GEOCENTER', 10.0, -10.5, 20.0, 20.5, 30.0, 30.5)
 * <p>In this example the function expresses a triangle, whose vertices are (10.0, -10.5), (20.0, 20.5) and (30.0, 30.5) in degrees
 * according to the STC coordinate system with GEOCENTER reference position.</i>
 * 
