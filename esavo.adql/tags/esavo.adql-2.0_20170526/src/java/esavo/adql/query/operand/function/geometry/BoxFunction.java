 ...
 * 
 * <p><i><u>Example:</u>
 * <p>BOX('ICRS GEOCENTER', 25.4, -20.0, 10, 10)
 * <p>In this example the function expressing a box o ten degrees centered in a position (25.4,-20.0) in degrees and defined according
 * to the ICRS coordinate system with GEOCENTER reference position.
 * <p>BOX('ICRS GEOCENTER', t.ra, t.dec, 10, 10)
 * <p>In this second example the coordinates of the center position are extracted from a coordinate's column reference.
 * </i>
 * 
 * 
