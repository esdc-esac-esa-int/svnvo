 ...
 * 
 * <p><i><u>Example:</u>
 * <p>CONTAINS(POINT('ICRS GEOCENTER', 25.0, -19.5), CIRCLE('ICRS GEOCENTER', 25.4, -20.0, 1)) = 1
 * <p>In this example the function determines if the point (25.0,-19.5) is within a circle of
 * one degree radius centered in a position of (25.4,-20.0).</i>
 * 
 * <p><b><u>Warning:</u></b>
 * <ul>
 * <li>The CONTAINS function returns 1 (true) if the first argument is in or on the boundary of the circle and 0 (false) otherwise.</li>
 ...
 * If it can not do so, it SHOULD throw an error message, to be defined by the service making use of ADQL.</li>
 * </ul>
 * 
 * 
