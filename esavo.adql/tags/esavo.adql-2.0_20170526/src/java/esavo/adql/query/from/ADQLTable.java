...
import esavo.adql.db.DefaultDBTable;
 ...
 * <p>A table reference may have an alias (MUST if it is a sub-query).
 * 
...
public class ADQLTable implements ADQLObject, FromContent {
	 ...
	 * <p><i><u>Note:</u> This information is added automatically by {@link DBChecker} when {@link DBChecker#check(esavo.adql.query.ADQLQuery)} is called.</i></p>
	 * 
