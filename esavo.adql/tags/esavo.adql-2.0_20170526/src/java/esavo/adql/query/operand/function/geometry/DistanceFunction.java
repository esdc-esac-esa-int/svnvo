 ...
 * 
 * <p><i><u>Example:</u>
 * <p>DISTANCE(POINT('ICRS GEOCENTER', 25.0, -19.5), POINT('ICRS GEOCENTER', 25.4, -20.0))
 * <p>In this example the function computes the distance between two points of coordinates (25, -19.5) and (25.4, -20) both expressed according to the ICRS
 * coordinate system with GEOCENTER reference position.</i>
 * 
