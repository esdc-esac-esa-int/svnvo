...
import esavo.adql.parser.ADQLQueryFactory.JoinType;

import esavo.adql.query.*;
import esavo.adql.query.from.*;
import esavo.adql.query.constraint.*;

import esavo.adql.query.operand.*;

import esavo.adql.query.operand.function.*;

import esavo.adql.query.operand.function.geometry.*;
...
{if ("" != null) return q;}
  ...
  final public void Select() throws ParseException {
    trace_call("Select");
    try {ClauseSelect select = query.getSelect(); SelectItem item=null; Token t = null;
...
select.add(item);
  ...
  final public SelectItem SelectItem() throws ParseException {
    ...
    try {IdentifierItems identifiers = new IdentifierItems(true); IdentifierItem id = null, label = null; ADQLOperand op = null;
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case ASTERISK:{
        jj_consume_token(ASTERISK);
{if ("" != null) return new SelectAllColumns(query);}
        break;
        }
      default:
        jj_la1[11] = jj_gen;
...
identifiers.append(id);
          ...
          jj_consume_token(ASTERISK);
try{;
                                        {if ("" != null) return new SelectAllColumns( queryFactory.createTable(identifiers, null) );}
                                }catch(Exception ex) {
                                        {if (true) throw generateParseException(ex);}
                                }
        } else {
...
{if (true) throw generateParseException(ex);}
  ...
  final public void Where() throws ParseException {
    trace_call("Where");
    try {ClauseConstraints where = query.getWhere(); ADQLConstraint condition;
  ...
  final public void GroupBy() throws ParseException {
    trace_call("GroupBy");
    try {ClauseADQL<ColumnReference> groupBy = query.getGroupBy(); ColumnReference colRef = null;
...
groupBy.add(colRef);
  ...
  final public void Having() throws ParseException {
    trace_call("Having");
    try {ClauseConstraints having = query.getHaving();
  ...
  final public void OrderBy() throws ParseException {
    trace_call("OrderBy");
    try {ClauseADQL<ADQLOrder> orderBy = query.getOrderBy(); ADQLOrder order = null;
...
try{
  ...
  final public ColumnReference ColumnRef() throws ParseException {
    ...
    try {IdentifierItems identifiers = null; Token ind = null;
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case DELIMITED_IDENTIFIER:
      case REGULAR_IDENTIFIER:{
        identifiers = ColumnName();
...
try{
  ...
  final public ADQLOrder OrderItem() throws ParseException {
    ...
    try {IdentifierItems identifiers = null; Token ind = null, desc = null;
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case DELIMITED_IDENTIFIER:
      case REGULAR_IDENTIFIER:{
        identifiers = ColumnName();
...
try{
  ...
  final public FromContent SimpleTableRef() throws ParseException {
    ...
    try {IdentifierItem alias = null; IdentifierItems identifiers = null; ADQLQuery subQuery = null; FromContent content = null;
      try {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case DELIMITED_IDENTIFIER:
        case REGULAR_IDENTIFIER:{
...
{if ("" != null) return queryFactory.createTable(identifiers, alias);}
          break;
          }
        default:
          jj_la1[27] = jj_gen;
          if (jj_2_2(2)) {
            ...
            alias = Identifier();
{if ("" != null) return queryFactory.createTable(subQuery, alias);}
          } else {
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case LEFT_PAR:{
              jj_consume_token(LEFT_PAR);
...
{if ("" != null) return content;}
  ...
  final public ADQLJoin JoinSpecification(FromContent leftTable) throws ParseException {
    ...
    try {boolean natural = false; JoinType type = JoinType.INNER;  ClauseConstraints condition = new ClauseConstraints("ON"); ArrayList<ADQLColumn> lstColumns=new ArrayList<ADQLColumn>(); IdentifierItem id; FromContent rightTable;
      try {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case NATURAL:{
...
type = JoinType.OUTER_FULL;
          ...
          rightTable = TableRef();
{if ("" != null) return queryFactory.createJoin(type, leftTable, rightTable);}
          break;
          }
        case INNER:
        case RIGHT:
...
{if ("" != null) return queryFactory.createJoin(type, leftTable, rightTable, condition);}
            break;
            }
          case USING:{
...
lstColumns.add( queryFactory.createColumn(id) );
            ...
            jj_consume_token(RIGHT_PAR);
{if ("" != null) return queryFactory.createJoin(type, leftTable, rightTable, lstColumns);}
            break;
            }
          default:
            jj_la1[39] = jj_gen;
...
{if ("" != null) return (str!=null)?str.substring(1,str.length()-1):str;}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("String");
    }
...
{if ("" != null) return ((sign==null)?"":sign.image)+number.image;}
    throw new Error("Missing return statement in function");
    } finally {
...
/* *********** */
  final public ADQLOperand ValueExpressionPrimary() throws ParseException {
    ...
    try {String expr; ADQLColumn column; ADQLOperand op;
      try {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case SCIENTIFIC_NUMBER:
        case UNSIGNED_FLOAT:
...
{if ("" != null) return queryFactory.createNumericConstant(expr);}
          break;
          }
        case STRING_LITERAL:{
          expr = String();
{if ("" != null) return queryFactory.createStringConstant(expr);}
          break;
          }
        case DELIMITED_IDENTIFIER:
        case REGULAR_IDENTIFIER:{
...
{if ("" != null) return op;}
        ...
        case LEFT_PAR:{
          ...
          op = ValueExpression();
          jj_consume_token(RIGHT_PAR);
{if ("" != null) return queryFactory.createWrappedOperand(op);}
          break;
          }
        default:
          jj_la1[46] = jj_gen;
...
{if (true) throw generateParseException(ex);}
  ...
  final public ADQLOperand ValueExpression() throws ParseException {
    ...
    try {ADQLOperand valueExpr = null;
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case BOX:
      case CENTROID:
      case CIRCLE:
...
if (sign == null)
                ...
                try{
                        {if ("" != null) return queryFactory.createOperation(leftOp, OperationType.getOperator(sign.image), rightOp);}
                }catch(Exception ex){
                        {if (true) throw generateParseException(ex);}
                }
        }
...
if (sign == null)
  ...
  final public ADQLOperand Factor() throws ParseException {
    trace_call("Factor");
    try {boolean negative = false;; ADQLOperand op;
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case PLUS:
      case MINUS:{
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return clause;}
  ...
  final public ADQLConstraint Constraint() throws ParseException {
    ...
    try {ADQLConstraint constraint =  null;
...
{if ("" != null) return constraint;}
  ...
  final public ADQLConstraint Predicate() throws ParseException {
    ...
    try {ADQLQuery q=null; ADQLColumn column=null; ADQLOperand strExpr1=null, strExpr2=null; ADQLOperand op; Token notToken = null; ADQLConstraint constraint = null;
      try {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case EXISTS:{
          jj_consume_token(EXISTS);
          q = SubQueryExpression();
{if ("" != null) return queryFactory.createExists(q);}
          break;
          }
        default:
          jj_la1[69] = jj_gen;
...
{if ("" != null) return queryFactory.createIsNull((notToken!=null), column);}
...
{if ("" != null) return queryFactory.createComparison(strExpr1, (notToken==null)?ComparisonOperator.LIKE:ComparisonOperator.NOTLIKE, strExpr2);}
          } else {
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case LEFT_PAR:
            case PLUS:
...
try{
                        {if ("" != null) return queryFactory.createComparison(leftOp, ComparisonOperator.getOperator(comp.image), rightOp);}
                }catch(Exception ex){
                        {if (true) throw generateParseException(ex);}
                }
    throw new Error("Missing return statement in function");
  ...
  final public Between BetweenEnd(ADQLOperand leftOp) throws ParseException {
    ...
    try {Token notToken=null; ADQLOperand min, max;
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case NOT:{
        notToken = jj_consume_token(NOT);
        break;
      ...
      max = ValueExpression();
try{
                        {if ("" != null) return queryFactory.createBetween((notToken!=null), leftOp, min, max);}
                }catch(Exception ex){
                        {if (true) throw generateParseException(ex);}
                }
    throw new Error("Missing return statement in function");
  ...
  final public In InEnd(ADQLOperand leftOp) throws ParseException {
    trace_call("InEnd");
    try {Token not=null; ADQLQuery q = null; ADQLOperand item; Vector<ADQLOperand> items = new Vector<ADQLOperand>();
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case NOT:{
...
try{
                        if (q != null)
                                {if ("" != null) return queryFactory.createIn(leftOp, q, not!=null);}
                        else{
                                ADQLOperand[] list = new ADQLOperand[items.size()];
                                int i=0;
                                for(ADQLOperand op : items)
                                        list[i++] = op;
                                {if ("" != null) return queryFactory.createIn(leftOp, list, not!=null);}
                        }
                }catch(Exception ex){
                        {if (true) throw generateParseException(ex);}
                }
...
/* ************* */
  final public SQLFunction SqlFunction() throws ParseException {
    ...
    try {Token fct, all=null, distinct=null; ADQLOperand op=null; SQLFunction funct = null;
      try {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case COUNT:{
...
{if ("" != null) return ops;}
  ...
  final public GeometryFunction GeometryFunction() throws ParseException {
    ...
    try {Token t=null; GeometryValue<GeometryFunction> gvf1, gvf2; GeometryValue<PointFunction> gvp1, gvp2; GeometryFunction gf = null; PointFunction p1=null, p2=null; ADQLColumn col1 = null, col2 = null;
      try {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case CONTAINS:
        case INTERSECTS:{
...
{if ("" != null) return gf;}
  ...
  final public ADQLOperand CoordinateSystem() throws ParseException {
    ...
    try {Token oldToken = token; ADQLOperand coordSys=null;
...
if (allowedCoordSys.size() > 0){
  ...
  final public GeometryFunction GeometryValueFunction() throws ParseException {
    ...
    try {ADQLOperand coordSys; ADQLOperand width, height; ADQLOperand[] coords, tmp; Vector<ADQLOperand> vCoords; ADQLOperand op=null; GeometryValue<GeometryFunction> gvf = null; GeometryFunction gf = null;
      try {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case BOX:{
...
gf = queryFactory.createCircle(coordSys, coords[0], coords[1], width);
        ...
        case RESOLVETARGET:{
          jj_consume_token(RESOLVETARGET);
          jj_consume_token(LEFT_PAR);
          op = StringExpression();
          jj_consume_token(RIGHT_PAR);
gf = queryFactory.createResolveTarget(op);
          break;
          }
        case POINT:{
          gf = Point();
...
{if ("" != null) return gf;}
  ...
  final public PointFunction Point() throws ParseException {
    trace_call("Point");
    try {ADQLOperand coordSys; ADQLOperand[] coords;
      ...
      jj_consume_token(RIGHT_PAR);
try{
                        {if ("" != null) return queryFactory.createPoint(coordSys, coords[0], coords[1]);}
                }catch(Exception ex){
                        {if (true) throw generateParseException(ex);}
                }
    throw new Error("Missing return statement in function");
  ...
  final public GeometryFunction ExtractCoordSys() throws ParseException {
    ...
    try {GeometryValue<GeometryFunction> gvf;
      jj_consume_token(COORDSYS);
      jj_consume_token(LEFT_PAR);
      gvf = GeometryExpression();
      jj_consume_token(RIGHT_PAR);
try{
                        {if ("" != null) return queryFactory.createExtractCoordSys(gvf);}
                }catch(Exception ex){
                        {if (true) throw generateParseException(ex);}
                }
    throw new Error("Missing return statement in function");
...
{if ("" != null) return fct;}
  ...
  final public MathFunction MathFunction() throws ParseException {
    ...
    try {Token fct=null; ADQLOperand param1=null, param2=null; String integerValue = null;
      try {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case ABS:{
...
{if (true) throw generateParseException(ex);}
  ...
  final public MathFunction TrigFunction() throws ParseException {
    ...
    try {Token fct=null; ADQLOperand param1=null, param2=null;
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case ACOS:{
...
try{
                        if (param1 != null)
                                {if ("" != null) return queryFactory.createMathFunction(MathFunctionType.valueOf(fct.image.toUpperCase()), param1, param2);}
                        else
                                {if ("" != null) return null;}
                }catch(Exception ex){
                        {if (true) throw generateParseException(ex);}
...
/* /!\ WARNING: The function name may be prefixed by "udf_" but there is no way to check it here ! */
  final public UserDefinedFunction UserDefinedFunction() throws ParseException {
    ...
    try {Token fct; Vector<ADQLOperand> params = new Vector<ADQLOperand>(); ADQLOperand op;
...
//System.out.println("INFO [ADQLParser]: \""+fct.image+"\" (from line "+fct.beginLine+" and column "+fct.beginColumn+" to line "+token.endLine+" and column "+(token.endColumn+1)+") is considered as an user defined function !");
                try{
                        ...
                        {if ("" != null) return queryFactory.createUserDefinedFunction(fct.image, parameters);}
 ...
 {
    if (jj_scan_token(RESOLVETARGET)) return true;
    if (jj_scan_token(LEFT_PAR)) return true;
    if (jj_3R_24()) return true;
    if (jj_scan_token(RIGHT_PAR)) return true;
    return false;
  ...
  private boolean jj_3R_44()
 {
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x1,0x400,0x800,0x1000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffff8000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x6000,0x6000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf8000,0x7f00000,0xf80f8000,0x0,0x0,0x0,0x0,0x0,0x0,0xf8000,0x0,0x0,0xf8000,0x7f00000,0x8,0x6,0x6,0x8,0x0,0x8,0x8,0x0,0x108,0x200,0xffff8000,0x0,0x8,0x8,0x0,0x0,0x0,0xffff8000,0x78000,0x0,0xf8000,0x18000000,0x800000,0x800000,0x800000,0x800000,0xf8000000,0x0,0x7f00000,0xf8000000,0xf80f8000,0x0,0x0,0x0,0x0,0x0,0xffff8000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x41ffffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x0,0x0,0x0,0x0,0x40000000,0x0,0x41fffffe,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x0,0x1,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x41ffffff,0x0,0x0,0x0,0x0,0x0,0x0,0x41ffffff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x1fffffe,0x41fffffe,0x0,0x0,0x1fffc,0x1fe0000,0x0,0x41ffffff,};
   }
