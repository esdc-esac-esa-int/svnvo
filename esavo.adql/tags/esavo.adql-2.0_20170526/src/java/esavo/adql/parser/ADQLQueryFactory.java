...
import esavo.adql.parser.IdentifierItems.IdentifierItem;
...
import esavo.adql.query.from.CrossJoin;
import esavo.adql.query.from.FromContent;
import esavo.adql.query.from.InnerJoin;
import esavo.adql.query.from.OuterJoin;
import esavo.adql.query.from.OuterJoin.OuterType;
...
import esavo.adql.query.operand.OperationType;
import esavo.adql.query.operand.StringConstant;
import esavo.adql.query.operand.WrappedOperand;
import esavo.adql.query.operand.function.DefaultUDF;
import esavo.adql.query.operand.function.MathFunction;
import esavo.adql.query.operand.function.MathFunctionType;
...
public class ADQLQueryFactory {
	...
	public ResolveTargetFunction createResolveTarget(ADQLOperand target) throws Exception{
		return new ResolveTargetFunction(target);
	}
