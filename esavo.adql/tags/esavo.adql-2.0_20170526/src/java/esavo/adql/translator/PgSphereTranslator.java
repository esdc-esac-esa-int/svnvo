...
public class PgSphereTranslator extends PostgreSQLTranslator {
	...
	public String translate(CentroidFunction fct) throws TranslationException{
		...
		if( fct.getParameter().getValue() instanceof CircleFunction || fct.getParameter().getValue() instanceof ResolveTargetFunction ){
			StringBuffer str = new StringBuffer("@@ ");
			str.append(translate(fct.getParameter()));
			return str.toString();
		} else {
			throw new TranslationException("Centroid only supported for circles");
		}
	}	
