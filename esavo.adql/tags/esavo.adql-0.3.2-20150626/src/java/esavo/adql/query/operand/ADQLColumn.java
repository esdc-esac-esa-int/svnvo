...
import esavo.adql.query.TextPosition;
...
public class ADQLColumn implements ADQLOperand {
	...
	/** The corresponding column in the "database". By default, this field is automatically filled by {@link esavo.adql.db.DBChecker}. */
	private DBColumn dbLink = null;

	/** The {@link ADQLTable} which is supposed to contain this column. By default, this field is automatically filled by {@link esavo.adql.db.DBChecker}. */
	 ...
	 * 
	 * <p>By default, this field is automatically filled by {@link esavo.adql.db.DBChecker}.</p>
	 * 
	 ...
	 * 
	 * <p>By default, this field is automatically filled by {@link esavo.adql.db.DBChecker} when {@link esavo.adql.db.DBChecker#check(esavo.adql.query.ADQLQuery)} is called.</p>
	 * 
