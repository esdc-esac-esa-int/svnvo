 ...
 *
 */
public class UwsShareCreate extends UwsShareAction implements UwsActionHandler {
	...
	public Parameters getParameters(UwsActionRequest actionRequest, Action action) throws UwsException {
		...
		case CreateOrUpdateGroup:
			//nothing to check
			parameters.groupId = actionRequest.getHttpParameter(PARAM_GROUP_ID);
			parameters.title = actionRequest.getHttpParameter(PARAM_TITLE);
			parameters.description = actionRequest.getHttpParameter(PARAM_DESCRIPTION);
			parameters.usersList = UwsHandlersUtils.getList(actionRequest.getHttpParameter(PARAM_USERS_LIST));
			break;
		case CreateUserGroup:
			//check userid exists
			...
			break;
		case CreateOrUpdateItem:
			parameters.resourceId = actionRequest.getHttpParameter(PARAM_RESOURCE_ID);
...
//	}
	...
	private List<UwsShareItem> createShareItemsListIfRequired(UwsActionRequest actionRequest){
		String sharedItemsListParam = actionRequest.getHttpParameter(PARAM_ITEMS_LIST);
