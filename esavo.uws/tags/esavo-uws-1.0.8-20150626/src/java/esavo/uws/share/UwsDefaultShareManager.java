...
public class UwsDefaultShareManager implements UwsShareManager {
	...
	public List<UwsShareGroup> getGroups(String userid, boolean includeUsers) throws UwsException {
		List<UwsShareGroup> groupsTheUserBelongsTo = getGroupsTheUserBelongsTo(userid);
		List<UwsShareGroup> groupsOwneredByUser = getGroupsByOwner(userid, includeUsers);
	...
	public List<UwsShareGroup> getGroupsTheUserBelongsTo(String userid) throws UwsException{
		List<UwsShareGroup> groups = storage.getGroupsTheUserBelongsTo(userid);
...
//		}
	...
	private boolean checkGroupBelongsOwner(String groupId, String ownerid) throws UwsException{
		UwsShareGroup group = storage.getGroup(groupId);
		if(group == null){
			//throw new UwsException(UwsOutputResponseHandler.BAD_REQUEST, "Group '"+groupId+"' not found.");
			return false;
		}
