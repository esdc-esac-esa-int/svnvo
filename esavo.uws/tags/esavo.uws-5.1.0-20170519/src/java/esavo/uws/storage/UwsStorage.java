...
public interface UwsStorage {
	...
	public static final boolean JOB_METADATA_ONLY = true;
	public static final boolean JOB_ENTIRE_DATA = false;
...
//	 * @return
//	 */
//	public List<UwsJob> getJobsMetaByList(String listName, List<UwsOwnerSessionFilter> ownersFilter, String appid) throws UwsException;

//	/**
//	 * Returns a list of jobs that belong to the provided listName and ownerid/session, restricted to a limit/offset.
//	 * @param listName
//	 * @param ownersFilter list of valid onwers/sessions
//	 * @param limit
//	 * @param offset
...
//	 * @return
//	 */
//	public List<UwsJob> getJobsMetaByList(String listName, List<UwsOwnerSessionFilter> ownersFilter, String appid, Integer limit, Integer offset, String order) throws UwsException;

	/**
	 * Returns a list of jobs based on the filter, restricted to a limit/offset with order
	 * Returns jobs meta only (not results nor errors)
	 * @param listName
	 * @param filter
	 * @param appid
	 * @param limit
	 * @param offset
	 * @param order
	 * @param onlyMeta if true, only metadata is loaded. If false, results,error and parameters are loaded too.
	 * @return
	 * @throws UwsException
	 */
	...
	/**
	 * Returns the number of jobs after applying the filter. (See {@link #getJobsByFilter(String, UwsJobsFilter, String, Integer, Integer, String, boolean)}
	 * @param listName
	 * @param filter
	 * @param appid
	 * @return
	 ...
	 * @return
	 */
	public Integer getNumberOfJobsByList(String listName, List<UwsOwnerSessionFilter> ownersFilter, String appid) throws UwsException;
...
//	/**
//	 * Returns jobs by filter (including results and error).
//	 * To retrieve jobs meta only, use {{@link #getJobsMetaByFilter(String, UwsJobsFilter, String, Integer, Integer, String)}}
//	 * @param filter
//	 * @param offset
//	 * @param limit
//	 * @return
...
//	public List<UwsJobDetails> retrieveJobsByFilter(UwsJobsFilter filter, long offset, long limit) throws UwsException;
	...
	/**
	 * Returns the jobs older than the specified 'time'. If a phase is provided, only jobs with that
	 * phase are searched.
	 * @param appid
	 * @param phaseId
	 * @param time
	...
	/**
	 * Removes the specified system warning notifications
	 * @param notificationid
	 * @throws UwsException
	 */
	public int deleteSystemWarningNotifications(List<String> notificationid) throws UwsException;
	...
	/**
	 * Utility to dump parameters from old schema to the new one (JSON). Only for DB.
	 * @throws UwsException
	 */
