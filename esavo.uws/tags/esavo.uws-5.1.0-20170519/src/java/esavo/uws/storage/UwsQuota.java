...
public class UwsQuota {
	...
	private long asyncMaxExecTime = 0;
	private long syncMaxExecTime = 0;
	
	public UwsQuota(String ownerId, long dbQuota, long dbCurrentSize, long fileQuota, long fileCurrentSize, long asyncMaxExecTime, long syncMaxExecTime){
		this.ownerId=ownerId;
		this.dbQuota=dbQuota;
		this.dbCurrentSize=dbCurrentSize;
		this.fileQuota=fileQuota;
		this.fileCurrentSize=fileCurrentSize;
		this.asyncMaxExecTime=asyncMaxExecTime;
	...
	*/
	...
	public void setAsyncMaxExecTime(long asyncMaxExecTime) {
		this.asyncMaxExecTime = asyncMaxExecTime;
	}

	public long getAsyncMaxExecTime() {
		return asyncMaxExecTime;
	}
	...
	public void setSyncMaxExecTime(long syncMaxExecTime) {
		this.syncMaxExecTime = syncMaxExecTime;
	}
	...
	public String toString(){
		return "Quota info for user: " + ownerId + ": db quota: " + dbQuota + ", current db size: " + dbCurrentSize +
				", file quota: " + fileQuota + ", current file size: " + fileCurrentSize + ", Max. async exec time: "+asyncMaxExecTime + ", Max. sync exec time: "+syncMaxExecTime;
	}
}
