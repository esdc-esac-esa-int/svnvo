...
public class DummyUwsPreparedStatement extends DummyUwsStatement implements PreparedStatement {
	
	private String query;
	private List<String> values;
	private List<Integer> positions;
	
	public DummyUwsPreparedStatement(String query, DummyUwsDatabaseDataAccessor dataAccessor, Connection connection){
