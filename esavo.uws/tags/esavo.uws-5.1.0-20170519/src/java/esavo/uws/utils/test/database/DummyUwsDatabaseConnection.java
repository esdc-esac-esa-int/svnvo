 ...
 *
 */
public class DummyUwsDatabaseConnection implements Connection, DummyUwsDatabaseDataAccessor {
	
	private Map<String, DummyUwsData> queriesAndResults;
	...
	public DummyUwsDatabaseConnection() {
		queriesAndResults = new HashMap<String, DummyUwsData>();
	...
	public void setDataForQuery(String query, DummyUwsData data){
	...
	public DummyUwsData getDataForQuery(String query) throws SQLException {
		...
		DummyUwsData d = queriesAndResults.get(query);
		if(d == null){
	...
	public Statement createStatement() throws SQLException {
		...
		return new DummyUwsStatement(this, this);
	}
	...
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		...
		return new DummyUwsPreparedStatement(sql, this, this);
	}
