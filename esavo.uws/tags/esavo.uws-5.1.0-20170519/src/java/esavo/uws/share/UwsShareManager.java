...
public interface UwsShareManager {
	...
	/**
	 * Returns the users that belong to the specified groups
	 * @param groupid
	 * @return
	 * @throws UwsException
	 */
	public List<UwsShareGroup> getGroupUsers(List<String> groupid) throws UwsException;
...
//	public List<UwsShareItem> getUserSharedItemsInfo(String userid, String resourceid, String resourceType) throws UwsException;
	...
	/**
	 * Updates the users properties (i.e. the name) based on user ids from the list. See {@link #updateGroupUsers(List)}
	 * @param users
	 * @throws UwsException
	 */
	...
	/**
	 * Updates the users properties (i.e. the name) for each group users list. See {@link #updateUsers(List)}}
	 * @param groups
	 * @throws UwsException
	 */
