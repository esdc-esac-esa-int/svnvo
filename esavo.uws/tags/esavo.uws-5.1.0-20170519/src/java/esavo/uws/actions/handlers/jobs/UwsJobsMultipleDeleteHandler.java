...
/**
 * Handles multiple jobs DELETE <code>{job_list}/deletejobs</code> or </br>
 ...
 *
 */
public class UwsJobsMultipleDeleteHandler implements UwsActionHandler {
	...
	public void handle(UwsManager uwsManager, UwsJobOwner currentUser, UwsActionRequest actionRequest, HttpServletResponse response) throws UwsException {
		...
		uwsManager.removeJobs(jobidsList, listid, currentUser);
